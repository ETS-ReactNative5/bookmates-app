...
const { addReview, editReview, deleteReview, likeReview, dislikeReview, getUserReviews, getFeedReviews} = require('../controllers/reviews');
...
router.get('/getFeedReviews', getFeedReviews);
